...
5. Establish a real pytest/coverage baseline — `docs/workflow.md`'s (then `conductor/workflow.md`) aspirational ">80%" was never actually measured.
...
- [x] Amended all 5 occurrences of the aspirational ">80%" in `docs/workflow.md` (then `conductor/workflow.md`) to the real, enforced floor.
